...
import {View, StyleSheet,KeyboardAvoidingView, FlatList, Alert, SafeAreaView, Text} from "react-native";
        ...
        return(
            <View style={styles.container}>
                ...
                <KeyboardAvoidingView style={styles.upperContainer}>
                    <CustomInput style={[styles.input, {height:75}]}
                    ...
                    <CustomInput style={[styles.input, {height:170}]}
                    inputContainerStyle={{height:140}}
                    label={"Reason"}
                    labelStyle={{fontSize:20}}
                    multiline
                    numberOfLines={8}
                    placeHolder={"Kindly provide your reason for requesting this particular book"}
                    onChangeText={text => {
                        this.setState({
